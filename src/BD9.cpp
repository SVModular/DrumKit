...
struct BD9Container bd9samples[ 16 ] = {
  { (float *)kick1, kick1_len },   { (float *)kick2, kick2_len },
  { (float *)kick3, kick3_len },   { (float *)kick4, kick4_len },
  { (float *)kick5, kick5_len },   { (float *)kick6, kick6_len },
  { (float *)kick7, kick7_len },   { (float *)kick8, kick8_len },
  { (float *)kick9, kick9_len },   { (float *)kick10, kick10_len },
  { (float *)kick11, kick11_len }, { (float *)kick12, kick12_len },
  { (float *)kick13, kick13_len }, { (float *)kick14, kick14_len },
  { (float *)kick15, kick15_len }, { (float *)kick16, kick16_len },
};
